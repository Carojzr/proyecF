...
func (h *Handler) ListarUsuarios(w http.ResponseWriter, r *http.Request) {
	...
	limit := 10 // por ejemplo, se puede cambiar según los requisitos
	offset := 0
	// Aquí podrías leer los valores de limit y offset de la solicitud si deseas implementar paginación

	// Llamar al controlador para listar usuarios
	usuarios, err := h.controller.ListarUsuarios(limit, offset)
	if err != nil {
